...
const formatString_1 = __importDefault(require("../format/formatString"));
const getHash_1 = __importDefault(require("../getHash/getHash"));
...
const hashTest = (toHash) => {
    const hash = (0, getHash_1.default)(toHash);
...
const formatTest = (char) => {
    ...
    const formatted = (0, formatString_1.default)(char);
    return formatted === char.toLowerCase();
};
const singularHashTest = (str) => {
    const hash = (0, getHash_1.default)(str);
    return typeof hash === "string" && hash.length === 32;
};
// for loop of set
for (const char of setOfAllLettersOfTheWorld) {
    if (!formatTest(char)) {
        console.log("ERROR", char, "formatted:", (0, formatString_1.default)(char));
    }
}
const buggyString = "👨‍👩‍👧‍👦";
const buggyStringHash = (0, getHash_1.default)(buggyString);
console.log("buggyStringHash", buggyStringHash);
const fmt = (0, formatString_1.default)(buggyString);
console.log("fmt", fmt);
const stringWithSpaces = "a CdğD* efğEFie üf,i.";
const fmt_two = (0, formatString_1.default)(stringWithSpaces);
console.log("fmt_two", fmt_two);
const elonmuskchild = "X Æ A-Xii ";
const fmt_three = (0, formatString_1.default)(elonmuskchild);
...
const fmt_four = (0, formatString_1.default)(halfArabicHalfJapaneseHalfSwedishHalfEnglishLetters);
console.log("fmt_four", fmt_four);
const hash_four = (0, getHash_1.default)(fmt_four);
